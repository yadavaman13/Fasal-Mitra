...
class DataLoader:
    ...
    def load_all(self):
        ...
        self.crop_yield = pd.read_csv('data/raw/crop_yield.csv')
        self.soil = pd.read_csv('data/raw/state_soil_data.csv')
        self.weather = pd.read_csv('data/raw/state_weather_data_1997_2020.csv')
        self.prices = pd.read_csv('data/raw/Price_Agriculture_commodities_Week.csv')
