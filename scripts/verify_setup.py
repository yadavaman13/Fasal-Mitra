...
def check_datasets():
    ...
    datasets = {
        'data/raw/crop_yield.csv': 'Core crop yield data',
        'data/raw/state_soil_data.csv': 'Soil NPK and pH data',
        'data/raw/state_weather_data_1997_2020.csv': 'Historical weather data',
