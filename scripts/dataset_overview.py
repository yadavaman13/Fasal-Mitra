...
def main():
    ...
    datasets = {
        'data/raw/crop_yield.csv': {'status': '✅', 'features': ['Yield Prediction', 'Season Recommender', 'Fertilizer Optimizer']},
        'data/raw/state_soil_data.csv': {'status': '✅', 'features': ['Soil Suitability Checker']},
        'data/raw/state_weather_data_1997_2020.csv': {'status': '✅', 'features': ['Climate Analysis', 'Historical Patterns']},
